...
export const workData = [
    {
        ...
        description: 'Artist and instructor Norman Ed was in need of a website redesign. On top of the refresh, pages to showcase his past/present exhibitions and mentions in the press, a biography, contact form, and a randomized custom 404 page were added.',
    ...
    },
    {
        ...
        description: 'A personal project, this online storefront for a fictional store gave me experience with Redux. Included is a randomized call to action on the home page, the ability to display items by category, a shopping cart, image magnification, and a randomized custom 404 page. Images from Madewell.',
    ...
    },
    {
        ...
        description: 'YouTube channel Baking Demystified needed a logo and channel art. I aimed to keep the look playful with the font selection and bright colors.',
        src: [
            bakingDemystifiedYoutube,
            bakingDemystifiedLogo1,
            bakingDemystifiedLogo2,
    ...
    },
    {
        ...
        description: 'Indoor Cities needed an album cover design for a musical digital release in 2013. The direction was to use natural photography and geometry. Their website was kept minimal to direct users to social media outlets and to showcase their music with select reviews and use of the Bandcamp plugin. I also created social media graphics, gig posters, and business cards for the group.',
        src: [
            indoorCitiesAlbum,
            indoorCitiesWebsite,
            indoorCitiesLogo,
